        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Add Guides</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="card card-primary">
                    ...
                    <form role="form">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Place_id</label>
                                <input type="integer" class="form-control" id="exampleInputEmail1" placeholder="Place_id">
                            </div>
                            <div class="form-group">
