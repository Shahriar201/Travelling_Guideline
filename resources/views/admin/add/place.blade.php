...
<div class="wrapper">
                ...
                <form action="{{ route('place.store') }}" method="post" novalidate="novalidate"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" type="text" placeholder="Enter Description " required="required" data-validation-required-message="Please enter your name."></textarea>
                            <p class="help-block text-danger"></p>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="location" id="location" type="text" placeholder="Enter Desctription " required="required" data-validation-required-message="Please enter your name."></textarea>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Region_Name</label>

                            <select name="region_id" id="region_id"
                                    class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                    data-select2-id="1" tabindex="-1" aria-hidden="true">
                                <option selected="selected" data-select2-id="3">Region Name</option>
    ...
    <script
        src="{{ asset ('asset/backend/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
    <!-- Summernote -->
